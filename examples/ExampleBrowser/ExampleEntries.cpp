...
//ExampleEntry(1, "Spheres & Plane C-API (Bullet3)", "Collision C-API using Bullet 3.x backend", CollisionTutorialBullet2CreateFunc,TUT_SPHERE_PLANE_RTB3),
		...
		ExampleEntry(1, "Test Arse", "Arse with mass of 750 kg, two cables of length 3m with mass 1kg", CableDemoCreateFunc, 6),
		ExampleEntry(1, "Test CollisionFreeCableWithStaticCube", "An attached cable falling on a static cuble", CableDemoCreateFunc, 7),
		ExampleEntry(1, "Test A18 0 gravity", "Cube with mass of 404 kg, cable length 15m, cable mass 3.6kg, iterations 100", CableDemoCreateFunc, 8),
